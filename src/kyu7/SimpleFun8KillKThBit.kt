...
fun main() {
    ...
    println(killKthBit(37, 4))
    println(killKthBit(0, 4))
    println(killKthBit(2147483647, 16))
    println(killKthBit(374823748, 13))
    println(killKthBit(1084197039, 15))
}

fun killKthBit(n: Int, k: Int) = n and (1 shl k - 1).inv()